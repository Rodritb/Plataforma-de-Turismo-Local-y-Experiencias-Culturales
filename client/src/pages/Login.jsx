...
import turistaImg from "../assets/iconos/turista.jpg";
...
export default function Login() {
  ...
  return (
    <div style={styles.page}>
      <div style={{ ...styles.bgImg, backgroundImage: `url(${fondoImg})` }} />
      ...
      <div style={styles.card}>
        <div style={styles.header}>
          <div style={{ ...styles.logoBox, background: c.gradient }}>
            <img src={ROLES.find(r => r.id === rol)?.icon} alt={rol}
...
const styles = {
  page: {
    position: "relative", minHeight: "100vh", width: "100%", margin: 0, padding: 0,
  ...
  bgOverlay: { position: "fixed", inset: 0, background: "rgba(0,0,0,0.18)", zIndex: 1 },
  topBar: { position: "fixed", top: 0, left: 0, right: 0, height: 4, zIndex: 10 },
  card: {
    position: "relative", zIndex: 2,
    background: "rgba(255,255,255,0.15)",
    backdropFilter: "blur(18px)", WebkitBackdropFilter: "blur(18px)",
    border: "1.5px solid rgba(255,255,255,0.35)", borderRadius: 22,
    boxShadow: "0 10px 48px rgba(0,0,0,0.3)",
    padding: "2.25rem 2rem", width: "100%", maxWidth: 420, marginRight: "5vw",
  },
